...
public class MovieContract {
    ...
    public static final String CONTENT_AUTHORITY = "com.udacity.popularmovies.debjyoti";


    public static final Uri BASE_CONTENT_URI = Uri.parse("content://" + CONTENT_AUTHORITY);


    public static final String PATH_MOVIE = "favmovie";
    ...
    public static final class MovieEntry implements BaseColumns {
        ...
        public static final String COLUMN_MOVIE_IMAGE_PATH="poster_path";
