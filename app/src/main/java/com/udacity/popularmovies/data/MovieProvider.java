...
public class MovieProvider extends ContentProvider {
    ...
    public static UriMatcher buildUriMatcher() {
         ...
         * they aren't going to change. In Sunshine, we use CODE_MOVIE or CODE_MOVIE_WITH_ID.
         */
        ...
        /*
         * This URI would look something like content://com.udacity.popularmovies.debjyoti/favmovie/1472214172
     ...
     * override it as MovieProvider extends ContentProvider and getType is an abstract method in
    ...
    /**
     * The idea is to first check if the id exists or not, if it exits delete it and if not then insert it
     *
